...
[x] Проверить, что за класс `aaa` в rss.html  
[ ] Использовать [mecon](https://github.com/elzik/mecon), чтобы проверять, нет ли неопознанных файлов в билиотеке.  
...
[ ] использовать [apscheduler](https://apscheduler.readthedocs.io/) для очистки кеша  
...
План разделения moviefilter:
- сканирование (можно объеденить с web_logger)
- импорт csv
- фронт
- core
- утилиты (кеширование, deleting_since_date)
